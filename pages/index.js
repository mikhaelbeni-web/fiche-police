...
// Verrou d'accès : la vérification du code se fait CÔTÉ SERVEUR (/api/auth).
// Le code n'est jamais présent dans ce fichier ni exposé au navigateur.
// Un cookie HttpOnly signé matérialise la session ; il est vérifié au chargement.
// Chaque navigateur demande le code une fois, puis le cookie prend le relais.
  ...
  return (
    <div className="gate">
      <div className="gate-box">
        <div className="gate-title">Fiches de Police</div>
