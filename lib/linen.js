...
// Les 7 articles suivis (validés par l'exploitant). Ordre et libellés alignés
// sur le document Excel du bon de ramassage (terme exact entre parenthèses).
export const LINEN_ARTICLES = [
  { key: "grande_serviette", label: "Grande serviette (Drap bain COCOON blc)" },
  { key: "housse", label: "Housse (Housse Stella S l. MARINE C260 blc)" },
  { key: "petite_serviette", label: "Petite serviette (Serv Eponge COCOON blc)" },
  { key: "tapis_bain", label: "Tapis de bain (Tapis bain harmony 49x70 blc)" },
  { key: "torchon", label: "Torchon à carreaux (Torchon carreaux bleus resid 47x70)" },
  { key: "taie", label: "Taie d'oreiller (Taie Am Clas blc 50x80 NF)" },
  { key: "drap", label: "Drap (Drap Clas blc l. noir 280 NF)" },
];
