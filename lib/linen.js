...
// Les 7 articles suivis (validés par l'exploitant).
export const LINEN_ARTICLES = [
  { key: "grande_serviette", label: "Grande serviette" },
  { key: "petite_serviette", label: "Petite serviette" },
  { key: "drap", label: "Drap" },
  { key: "housse", label: "Housse" },
  { key: "taie", label: "Taie d'oreiller" },
  { key: "tapis_bain", label: "Tapis de bain" },
  { key: "torchon", label: "Torchon à carreaux" },
];
